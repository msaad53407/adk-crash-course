...
AGENT_DESCRIPTION = "An agent that helps users manage and remember their reminders."
AGENT_INSTRUCTIONS = """
    ...
    **REMINDER MANAGEMENT GUIDELINES:**
    ...
    IMPORTANT:
    - Always use relevant tools for managing reminders.
...
"""
This is a simple reminder agent that can add, list, update, delete and clear reminders.
It also allows updating the user's name.
"""
root_agent = Agent(
    name="reminder_agent",
    model=AGENT_MODEL,
